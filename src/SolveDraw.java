...
public class SolveDraw {
    ...
    public void start(File sourceFile, Integer range_value, Integer speed_value, Integer minAmp_value, Integer maxAmp_value, Integer min_pts, Integer max_pts) throws IOException {
